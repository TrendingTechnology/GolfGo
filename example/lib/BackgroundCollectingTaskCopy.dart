      ...
      while (true) {
        ...
        if (index >= 0 && _buffer.length - index >= 7) {
          final DataSample sample = DataSample(
              lieAngle: (_buffer[index + 3] + _buffer[index + 4]).toDouble(),
              swingSpeed: (_buffer[index + 5] + _buffer[index + 6]).toDouble(),
              shaftLean: (_buffer[index + 7] + _buffer[index + 8]).toDouble(),
